...
- it can compare Excel tables that structurally differ - different headers, different order of columns
  and/or rows.
- Fully automatic comparison process if columns' names in either tables' are identical. In this case, the tool will mark all discovered
...
that if you use parts of the source code in your own work you should mention the author's name in the derivative source code.
