...
public:
    ...
    void Activate() { InvokeHelper(0x130, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void ForwardMailer() { InvokeHelper(0x3cd, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void __PrintOut(VARIANT& From, VARIANT& To, VARIANT& Copies, VARIANT& Preview, VARIANT& ActivePrinter,
    ...
    void _ProtectSharing(VARIANT& Filename, VARIANT& Password, VARIANT& WriteResPassword, VARIANT& ReadOnlyRecommended,
                         VARIANT& CreateBackup, VARIANT& SharingPassword)
    {
    ...
    void RefreshAll() { InvokeHelper(0x5ac, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    void Reply() { InvokeHelper(0x3d1, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    void ReplyAll() { InvokeHelper(0x3d2, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void Route() { InvokeHelper(0x3b2, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    BOOL get_Routed()
    {
        BOOL result;
    ...
    void Save() { InvokeHelper(0x11b, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    void _SaveAs(VARIANT& Filename, VARIANT& FileFormat, VARIANT& Password, VARIANT& WriteResPassword,
                 ...
                 VARIANT& AddToMru, VARIANT& TextCodepage, VARIANT& TextVisualLayout)
    {
        ...
        InvokeHelper(0x11c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Filename, &FileFormat, &Password,
                     &WriteResPassword, &ReadOnlyRecommended, &CreateBackup, AccessMode, &ConflictResolution, &AddToMru,
    ...
    void UpdateFromFile() { InvokeHelper(0x3e3, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void PivotTableWizard(VARIANT& SourceType, VARIANT& SourceData, VARIANT& TableDestination, VARIANT& TableName,
                          VARIANT& RowGrand, VARIANT& ColumnGrand, VARIANT& SaveData, VARIANT& HasAutoFormat,
                          VARIANT& AutoPage, VARIANT& Reserved, VARIANT& BackgroundQuery, VARIANT& OptimizeCache,
                          VARIANT& PageFieldOrder, VARIANT& PageFieldWrapCount, VARIANT& ReadData, VARIANT& Connection)
    {
        static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT
            VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
        InvokeHelper(0x2ac, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &SourceType, &SourceData, &TableDestination,
                     &TableName, &RowGrand, &ColumnGrand, &SaveData, &HasAutoFormat, &AutoPage, &Reserved,
                     &BackgroundQuery, &OptimizeCache, &PageFieldOrder, &PageFieldWrapCount, &ReadData, &Connection);
    }
    void ResetColors() { InvokeHelper(0x5bc, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void FollowHyperlink(LPCTSTR Address, VARIANT& SubAddress, VARIANT& NewWindow, VARIANT& AddHistory,
    ...
    void AddToFavorites() { InvokeHelper(0x5c4, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    BOOL get_IsInplace()
    {
        BOOL result;
    ...
    void _PrintOut(VARIANT& From, VARIANT& To, VARIANT& Copies, VARIANT& Preview, VARIANT& ActivePrinter,
                   VARIANT& PrintToFile, VARIANT& Collate, VARIANT& PrToFileName)
    {
        ...
        InvokeHelper(0x6ec, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &From, &To, &Copies, &Preview, &ActivePrinter,
                     &PrintToFile, &Collate, &PrToFileName);
    }
    void WebPagePreview() { InvokeHelper(0x71a, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void Dummy16() { InvokeHelper(0x800, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
                ...
                VARIANT& AddToMru, VARIANT& TextCodepage, VARIANT& TextVisualLayout, VARIANT& Local)
    {
        ...
        InvokeHelper(0x785, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Filename, &FileFormat, &Password,
                     &WriteResPassword, &ReadOnlyRecommended, &CreateBackup, AccessMode, &ConflictResolution, &AddToMru,
    ...
    void SendForReview(VARIANT& Recipients, VARIANT& Subject, VARIANT& ShowMessage, VARIANT& IncludeAttachment)
    {
        ...
        InvokeHelper(0x806, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Recipients, &Subject, &ShowMessage,
                     &IncludeAttachment);
    }
    ...
    void EndReview() { InvokeHelper(0x80a, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void SetPasswordEncryptionOptions(VARIANT& PasswordEncryptionProvider, VARIANT& PasswordEncryptionAlgorithm,
                                      VARIANT& PasswordEncryptionKeyLength, VARIANT& PasswordEncryptionFileProperties)
    {
        static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    ...
    void RecheckSmartTags() { InvokeHelper(0x811, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void ToggleFormsDesign() { InvokeHelper(0x8e7, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void LockServerFile() { InvokeHelper(0x9d8, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void PrintOut(VARIANT& From, VARIANT& To, VARIANT& Copies, VARIANT& Preview, VARIANT& ActivePrinter,
                  VARIANT& PrintToFile, VARIANT& Collate, VARIANT& PrToFileName, VARIANT& IgnorePrintAreas)
    {
        static BYTE parms[] =
            VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
        InvokeHelper(0x939, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &From, &To, &Copies, &Preview, &ActivePrinter,
    ...
    void EnableConnections() { InvokeHelper(0x9e9, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    ...
    void ProtectSharing(VARIANT& Filename, VARIANT& Password, VARIANT& WriteResPassword, VARIANT& ReadOnlyRecommended,
                        VARIANT& CreateBackup, VARIANT& SharingPassword, VARIANT& FileFormat)
    {
        static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
        InvokeHelper(0x9ef, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Filename, &Password, &WriteResPassword,
                     &ReadOnlyRecommended, &CreateBackup, &SharingPassword, &FileFormat);
    }
    ...
    void Dummy26() { InvokeHelper(0xb35, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
    void Dummy27() { InvokeHelper(0xb36, DISPATCH_METHOD, VT_EMPTY, NULL, NULL); }
