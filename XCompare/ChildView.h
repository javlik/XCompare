...
public:
	 ...
	 */
    void pickFile(bool* pNewFile, ExcelConnector* pExcel, Table* pTable, CMFCRibbonComboBox* pSheetCombo,
                  CString* pFilename);
	 ...
	 */
    void pickSheet(ExcelConnector* pExcel, Table* pTable, CMFCRibbonComboBox* pSheetCombo,
...
private:
    ...
    std::vector<SimilaritiesAcrossTables>
        m_vecSimilaritiesAcrossTables; ///< Raw similarity scores (one entry per column pair).
    std::vector<SimilaritiesAcrossTables>
        m_vecSimilaritiesAcrossTablesSorted; ///< Same as above, sorted by descending score.
