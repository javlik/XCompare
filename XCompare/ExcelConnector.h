...
{
public:
    ExcelConnector() : m_covOptional(COleVariant((long)DISP_E_PARAMNOTFOUND, VT_ERROR)) {}
    ...
    bool openFile(const CString& path, CApplication& app)
    {
        ...
        m_Book = m_Books.Open(path, m_covOptional, m_covOptional, m_covOptional, m_covOptional, m_covOptional,
                              m_covOptional, m_covOptional, m_covOptional, m_covOptional, m_covOptional, m_covOptional,
                              m_covOptional, m_covOptional, m_covOptional);
